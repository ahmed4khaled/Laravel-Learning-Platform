                ...
                @foreach ($Lec1 as $item)
                    <div class="lesson-card animate-on-load animate-delay-1">
                        <div class="lesson-thumbnail">
                            <!-- <img src="{{ asset('assest/img/' . $item['img']) }}" alt="" style="width:60px;height:60px;border-radius:50%;"> -->
                        </div>
                        <div class="lesson-content">
                            ...
                            <div class="lesson-meta">
                                <span class="lesson-duration"><i class="ri-time-line"></i> {{ $item['duration'] ?? '' }}</span>
