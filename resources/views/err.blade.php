...
<div class="main-error-page">
    ...
    <h1 class="error-title">
        Woops! <br> كلم الدعم الفني و ابعت اسكرين من هنا<br>
        <li class="social-icon__item"><a class="social-icon__link" href="https://wa.me/qr/HBKUUUDP5XPRB1"
                target="_blank">
                <i class="ri-customer-service-line black"></i>
            </a></li>
    </h1>
