...
<main class="main">
    ...
    <div class="login-form-wrapper animate-on-load">
        <div class="login-header">
            ...
            <p class="login-subtitle">املأ النموذج التالي للتسجيل</p>
        </div>
        ...
        <form class="login-form" method="POST" action="{{ route('register') }}">
            ...
            <div class="form-group animate-delay-4">
                ...
                <label for="Phone_par"> رقم هاتف ولي الأمر</label>
                <div class="input-container">
                    <input type="tel" name="Phone_par" id="Phone_par" value="{{ old('Phone_par') }}" required>
            ...
            <div class="form-group animate-delay-6">
              ...
              <div class="form-group animate-delay-6">
                <label for="type"> بتحضر ازاي</label>
                <div class="input-container">
            ...
            <div class="form-group animate-delay-7">
            ...
            <div class="form-group animate-delay-8">
                <label for="password_confirmation">تأكيد كلمة المرور</label>
                <div class="input-container">
                    <input type="password" name="password_confirmation" id="password_confirmation" required>
                    <i class="fas fa-lock input-icon"></i>
                    <button type="button" class="toggle-password" id="toggleConfirmPassword"><i class="fas fa-eye"></i></button>
                    <div class="input-glow"></div>
                </div>
            </div>
            </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.getElementById('device_token').value = token;
            ...
            <button type="submit" class="btn btn-primary login-submit-btn animate-delay-9">
                <i class="ri-user-add-line"></i>
            ...
            <p class="signup-link animate-delay-10">
                لديك حساب بالفعل؟
                @if (Route::has('login'))
        ...
        <div class="welcome-side">
                    <div class="welcome-content">
                        ...
                        <p>ابدأ رحلتك التعليمية مع أفضل معلم فيزياء في مصر</p>
                        
                        <div class="features-list">
                            <div class="feature-item">
                                <i class="fas fa-star"></i>
                                <span>شرح مبسط ومفصل</span>
                            </div>
                            <div class="feature-item">
                                <i class="fas fa-video"></i>
                                <span>محاضرات مسجلة عالية الجودة</span>
                            </div>
                            <div class="feature-item">
     ...
     <div class="stats-container">
                        ...
                        <div class="testimonial">
                            <div class="testimonial-content">
                                ...
                                <p>"أفضل معلم فيزياء! شرحه واضح ومبسط جداً"</p>
